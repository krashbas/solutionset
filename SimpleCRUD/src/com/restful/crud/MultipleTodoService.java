...
public class MultipleTodoService {
	// Allows to insert contextual objects into the class,
	  ...
	  public void newTodo(@FormParam("id") String id,
	      ...
	      @FormParam("complete-date") String completeDate,
	      @Context HttpServletResponse servletResponse) throws IOException {
	    Todo todo = new Todo(id, summary, completeDate);
	  ...
	  @Path("{todo}")
	  public TodoService getTodo(@PathParam("todo") String id) {
	    return new TodoService(uriInfo, request, id);
	  }
